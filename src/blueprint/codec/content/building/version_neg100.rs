...
mod test {
    ...
    fn test_serialization_version_neg100() {
        let bin_expected: Vec<u8> = vec![
            156, 255, 255, 255, 1, 0, 0, 0, 2, 102, 102, 70, 64, 51, 51, 131, 64, 51, 51, 163, 64,
            51, 51, 19, 65, 51, 51, 35, 65, 51, 51, 51, 65, 51, 51, 195, 64, 51, 51, 67, 65, 51,
            51, 227, 64, 15, 0, 16, 0, 17, 0, 0, 0, 18, 0, 0, 0, 19, 20, 21, 22, 23, 24, 25, 0, 26,
