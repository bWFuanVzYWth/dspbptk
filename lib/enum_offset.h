...
typedef enum                                    {
        building_neg100_offset_num              = 0,
        building_neg100_offset_index            = building_neg100_offset_num               + 4,
        building_neg100_offset_areaIndex        = building_neg100_offset_index             + 4,
        building_neg100_offset_localOffset_x    = building_neg100_offset_areaIndex         + 1,
        building_neg100_offset_localOffset_y    = building_neg100_offset_localOffset_x     + 4,
        building_neg100_offset_localOffset_z    = building_neg100_offset_localOffset_y     + 4,
        building_neg100_offset_localOffset_x2   = building_neg100_offset_localOffset_z     + 4,
        building_neg100_offset_localOffset_y2   = building_neg100_offset_localOffset_x2    + 4,
        building_neg100_offset_localOffset_z2   = building_neg100_offset_localOffset_y2    + 4,
        building_neg100_offset_yaw              = building_neg100_offset_localOffset_z2    + 4,
        building_neg100_offset_yaw2             = building_neg100_offset_yaw               + 4,
        building_neg100_offset_tilt             = building_neg100_offset_yaw2              + 4,
        building_neg100_offset_itemId           = building_neg100_offset_tilt              + 4,
        building_neg100_offset_modelIndex       = building_neg100_offset_itemId            + 2,
        building_neg100_offset_tempOutputObjIdx = building_neg100_offset_modelIndex        + 2,
        building_neg100_offset_tempInputObjIdx  = building_neg100_offset_tempOutputObjIdx  + 4,
        building_neg100_offset_outputToSlot     = building_neg100_offset_tempInputObjIdx   + 4,
        building_neg100_offset_inputFromSlot    = building_neg100_offset_outputToSlot      + 1,
        building_neg100_offset_outputFromSlot   = building_neg100_offset_inputFromSlot     + 1,
        building_neg100_offset_inputToSlot      = building_neg100_offset_outputFromSlot    + 1,
        building_neg100_offset_outputOffset     = building_neg100_offset_inputToSlot       + 1,
        building_neg100_offset_inputOffset      = building_neg100_offset_outputOffset      + 1,
        building_neg100_offset_recipeId         = building_neg100_offset_inputOffset       + 1,
        building_neg100_offset_filterId         = building_neg100_offset_recipeId          + 2,
        building_neg100_offset_numParameters    = building_neg100_offset_filterId          + 2,
        building_neg100_offset_parameters       = building_neg100_offset_numParameters     + 2
}building_neg100_offset_t;
